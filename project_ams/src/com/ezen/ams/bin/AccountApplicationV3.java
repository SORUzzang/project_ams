...
public class AccountApplicationV3 {
    ...
    public static void main(String[] args) {
        ...
        accountService.addAccount(new Account("1111-1111", "김솔", 1111, 10000));
        accountService.addAccount(new Account("1111-2222", "강솔", 1111, 10000));
        accountService.addAccount(new Account("1111-3333", "이솔", 1111, 10000));
    ...
    private static void printHeader(){
        System.out.println("-----------------------------------------------------");
        System.out.printf("%1$-11s%2$-9s%3$-8s%4$-13s\n", "계좌번호", "예금주명" , "비밀번호", "잔액");
        System.out.println("-----------------------------------------------------");
    }

    /**
     * 계좌 데이터 출력
     * @param account 출력하고자 하는 계좌
     */
    private static void printRow(Account account){
        System.out.printf("%1$-15s%2$-10s%3$-12s%4$,-13d\n",
